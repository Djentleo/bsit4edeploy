                ...
                <div class="lg:col-span-2 space-y-4">
                    ...
                    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <input type="text" name="incident_type" value="Traffic Accident" class="w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-50" readonly>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Priority Level</label>
                                <input type="text" name="priority_level" value="High" class="w-full px-3 py-2 border border-gray-300 rounded-md bg-red-50 text-red-700" readonly>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <input type="text" name="reporter_name" value="Juan Dela Cruz" class="w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-50" readonly>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Contact Number</label>
                                <input type="text" name="contact_number" value="+63 912 345 6789" class="w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-50" readonly>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <input type="text" name="date_time" value="Aug 21, 2025 - 2:30 PM" class="w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-50" readonly>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Status</label>
                                <input type="text" name="status" value="Pending Dispatch" class="w-full px-3 py-2 border border-gray-300 rounded-md bg-yellow-50 text-yellow-700" readonly>
                            </div>
                        </div>
                        
                        <div class="mb-4">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Description</label>
                            <textarea rows="3" name="description" class="w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-50" readonly>Multiple vehicle collision at the intersection of EDSA and Quezon Avenue. Two cars involved, possible injuries reported. Traffic is heavily congested.</textarea>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="address" value="EDSA cor. Quezon Avenue, Quezon City, Metro Manila" class="w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-50" readonly>
                        </div>
                        ...
                        <div class="bg-gray-100 rounded-lg h-64 flex items-center justify-center mb-4 border-2 border-dashed border-gray-300">
                            <div class="text-center">
                                ...
                                <p class="text-gray-600 font-medium">EDSA cor. Quezon Avenue</p>
                                <p class="text-sm text-gray-500">Lat: 14.6042, Lng: 121.0306</p>
                            </div>
                        </div>
                    </div>

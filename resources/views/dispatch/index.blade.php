        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="space-y-3">
                        <button
                            class="w-full bg-green-600 text-white py-3 px-4 rounded-lg flex items-center justify-between hover:bg-green-700 transition-colors group">
                        ...
                        <button
                            class="w-full bg-orange-600 text-white py-3 px-4 rounded-lg flex items-center justify-between hover:bg-orange-700 transition-colors group">
                            <span class="flex items-center">
                                <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd"
                        ...
                        <button
                            class="w-full bg-red-600 text-white py-3 px-4 rounded-lg flex items-center justify-between hover:bg-red-700 transition-colors group">
                            <span class="flex items-center">
                                <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd"

<body style="background: #f4f6fb; padding: 40px 0; font-family: 'Segoe UI', Arial, sans-serif;">
    <div
        ...
        <p style="color: #333; font-size: 1.1rem;">Your account has been created for the <strong>Barangay Baritan
                Incident Report and Management System</strong>.</p>
        ...
        <p style="color: #444;">You can now log in using these credentials. <span
                style="color: #d32f2f; font-weight: bold;">For security, please change your password after your first
                login.</span></p>

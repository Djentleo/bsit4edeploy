    ...
    <div x-show="open" x-transition:enter="transition ease-out duration-200"
        ...
        <div
            ...
            <div class="flex items-center gap-1.5 flex-wrap">
                <span class="text-xs font-semibold text-gray-500 dark:text-gray-400">Sort:</span>
                <button
        ...
        <div
            ...
            <div class="relative group">
                <a href="{{ url('/responder/incidents/' . ($notif['dispatch_id'] ?? $notif['incident_id'])) }}"
                   class="block px-5 py-4 hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 dark:hover:from-gray-700 dark:hover:to-gray-600 transition-all duration-200 group @if(!$notif['read']) bg-blue-50/30 dark:bg-blue-900/10 @endif">
                    <div class="flex items-start gap-3">
                        <!-- Icon with type-specific styling -->
                        <div class="flex-shrink-0 mt-1">
                            <span
                                class="inline-flex items-center justify-center w-8 h-8 rounded-full @if($notif['type']==='incident') bg-blue-100 dark:bg-blue-900/30 @elseif($notif['type']==='note') bg-purple-100 dark:bg-purple-900/30 @else bg-gray-100 dark:bg-gray-700 @endif">
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="flex items-center gap-2 mb-1.5">
                                <span
                                    class="inline-flex items-center px-2 py-0.5 rounded-md text-xs font-medium @if($notif['type']==='incident') bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300 @elseif($notif['type']==='note') bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-300 @else bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-300 @endif">
                ...
                <!-- Delete/hide button -->
                <button wire:click="deleteNotification('{{ $notif['incident_id'] }}')"
